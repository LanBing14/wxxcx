...
class WxValidate {
    ...
    __initDefaults() {
        this.defaults = {
            messages: {
                ...
                phone: '格式须为固定电话或手机号码，例：0512-12345678或13012345678',
                mobile: '输入手机号码格式不正确',
            }
        }
    }
    ...
    __initMethods() {
        ...
        that.methods = {
             ...
             */
            float(value) {
              return that.optional(value) || /^(([1-9]\d*)|(([1-9]\d*)\.[0-9][0-9]{0,1})|(0\.(0[1-9]|[1-9][0-9]{0,1}))|(\.0{1,2}))$/.test(value)
            },
            /**
             * 只允许正整数
             */
            cipint(value) {
              return that.optional(value) || /^[1-9][0-9]*$/.test(value)
            },
            /**
             * 验证两个输入框的内容是否相同
             */
            ...
            phone(value, param) {
              return that.optional(value) || /^((0\d{2,3}-\d{7,8})|(1[3|4|5|7|8|9]\d{9}))$/.test(value)
            },
            mobile(value, param) {
              return that.optional(value) || /^1[3|4|5|7|8|9]\d{9}$/.test(value)
            }
        }
    }
